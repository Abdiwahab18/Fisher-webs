...
import { currentUser, listUsers, listFishermen, deleteUser, updateUserStatusController, getSystemStatsController, getRevenueAnalytics, updateProfileController, getAdminContactController } from '../controllers/userController.js';

const router = express.Router();

router.get('/me', authenticateToken, currentUser);
router.patch('/me/profile', authenticateToken, updateProfileController);
router.get('/admin-contact', authenticateToken, getAdminContactController);
